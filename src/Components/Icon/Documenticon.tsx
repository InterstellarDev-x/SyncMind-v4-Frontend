...
export const DocumentIcon = (props : iconsize)=>{
    return (
        <div >
           <svg fill={props.sidebar ? "#fcfbff" : "#000000"} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
